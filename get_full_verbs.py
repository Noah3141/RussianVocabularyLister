...
override_list = {"калывать":"колоть","крывать":"крыть", "едать":"есть","ведать":"вести","метать":"мести","ключать":"ключить","водить":"вести","дергивать":"дергать","мазывать":"мазать","даривать":"дарить","кутывать":"кутать","бегать":"бежать",
                 ...
                 "плывать":"плыть","мывать":"мыть", "гонять":"гнать","вывать":"выть","нывать":"ныть","забывать":"забыть","орать":"орать","плескивать":"плескать", "слонять":"слонить","стигать":"стигнуть","ветвлять":"ветвить","мещать":"местить",
                 "вертывать":"вертеть","швыривать":"швырнуть","сыпать":"сыпать","тягивать":"тянуть","пускать":"пустить","жидать":"ждать","брасывать":"бросать","хлестывать":"хлестать", "стригать":"стричь","целивать":"целить","таскивать":"таскать",
                 ...
                 "решать":"решить","гружать":"грузить","бредать":"брести","винчивать":"винтить","ливать":"лить","вивать":"вить","мучивать":"мучить","молять":"молить","рушать":"рушить","кушивать":"кушать","селять":"селить","мешивать":"мешать",
                 ...
                 "пекать":"печь","вирать":"врать","лыгать":"лгать","тушать":"тушить","стаивать":"стоить","грызать":"грызть","седать":"сесть","гревать":"греть","дувать":"дуть","маивать":"маять","мигивать":"мигать","цеплять":"цепить","увечивать":"увечить",
                 "таивать":"таить","манывать":"мануть","шагивать":"шагать","стерегать":"стеречь","хлынивать":"хлынуть","плавливать":"плавить","валивать":"валить","купать":"купить","прятывать":"прятать","вевать":"веять","хаживать":"ходить",
