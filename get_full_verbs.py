...
override_list = {"калывать":"колоть","крывать":"крыть", "едать":"есть","ведать":"вести","метать":"мести","ключать":"ключить","водить":"вести","дергивать":"дергать","мазывать":"мазать",
                 ...
                 "тирать":"тереть","буждать":"будить","плетать":"плести","влекать":"влечь","тыкать":"ткнуть","берегать":"беречь","читывать":"читать","давать":"дать", "шибать":"шибить","рекать":"речь",
                 ...
                 "чинивать":"чинить","чинять":"чинить","гибать":"гибать","качивать":"качать","следовать":"следовать","цветать":"цвести","хваливать":"хвалить","сылать":"слать","манивать":"манить","блуждать":"блудить",
                 "решать":"решить","гружать":"грузить","бредать":"брести","винчивать":"винтить","ливать":"лить","вивать":"вить","мучивать":"мучить","молять":"молить","рушать":"рушить",
